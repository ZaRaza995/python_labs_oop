...
Научиться создавать новые типы объектов на основе старых, чтобы не переписывать один и тот же код сто раз и научить программу автоматически понимать, кого и как лечить.
